...
/* ================================
   SETTING ALBUM JAM KOSONG
================================ */

// Ubah jumlah foto jam kosong yang kamu punya di sini
const totalPhotos = 23;

// Pastikan kamu bikin folder 'jamkosong' di dalam folder 'img'
const photoFolder = "image/jamkosong";
const photoPrefix = "jamkosong";
...
function createPhotoCard(index){
  ...
  button.innerHTML = `
    <img src="${firstSrc}" alt="Foto jam kosong ${index}" loading="lazy" decoding="async">
    <span>Momen ${index}</span>
  `;
