...
/* ================================
   SETTING ALBUM MOMEN RANDOM
================================ */

// Sesuaikan jumlah foto random yang kamu punya
const totalPhotos = 413;

// Sesuaikan nama folder dan awalan file kamu di laptop.
// Misalnya foldernya "image/random" dan nama fotonya "random (1).jpg", "random (2).jpg", dst.
const photoFolder = "image/random"; 
const photoPrefix = "random";
...
function createPhotoCard(index){
  ...
  button.innerHTML = `
    <img 
      src="${firstSrc}" 
      alt="Foto Random ${index}" 
      loading="lazy" 
      decoding="async"
    >
    <span>Momen Absurd ${index}</span>
  `;
